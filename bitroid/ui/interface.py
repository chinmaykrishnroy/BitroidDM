...
from bitroid.ui.styles import *
from bitroid.ui import res
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.filesBackBtn = QPushButton(self.filesUtilityFrame)
        self.filesBackBtn.setObjectName(u"filesBackBtn")
        self.filesBackBtn.setMaximumSize(QSize(32, 16777215))
        iconFilesBack = QIcon()
        iconFilesBack.addFile(u":/icons/icons/chevron-left.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.filesBackBtn.setIcon(iconFilesBack)
        self.filesBackBtn.setIconSize(QSize(18, 18))

        self.horizontalLayout_24.addWidget(self.filesBackBtn)

        self.filesForwardBtn = QPushButton(self.filesUtilityFrame)
        self.filesForwardBtn.setObjectName(u"filesForwardBtn")
        self.filesForwardBtn.setMaximumSize(QSize(32, 16777215))
        iconFilesForward = QIcon()
        iconFilesForward.addFile(u":/icons/icons/chevron-right.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.filesForwardBtn.setIcon(iconFilesForward)
        self.filesForwardBtn.setIconSize(QSize(18, 18))

        self.horizontalLayout_24.addWidget(self.filesForwardBtn)

        self.filesUpBtn = QPushButton(self.filesUtilityFrame)
        self.filesUpBtn.setObjectName(u"filesUpBtn")
        self.filesUpBtn.setMaximumSize(QSize(32, 16777215))
        iconFilesUp = QIcon()
        iconFilesUp.addFile(u":/icons/icons/arrow-up.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.filesUpBtn.setIcon(iconFilesUp)
        self.filesUpBtn.setIconSize(QSize(18, 18))

        self.horizontalLayout_24.addWidget(self.filesUpBtn)

        self.filesHomeBtn = QPushButton(self.filesUtilityFrame)
        self.filesHomeBtn.setObjectName(u"filesHomeBtn")
        self.filesHomeBtn.setMaximumSize(QSize(32, 16777215))
        iconFilesHome = QIcon()
        iconFilesHome.addFile(u":/icons/icons/home.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.filesHomeBtn.setIcon(iconFilesHome)
        self.filesHomeBtn.setIconSize(QSize(18, 18))

        self.horizontalLayout_24.addWidget(self.filesHomeBtn)

        self.filesPathInput = QLineEdit(self.filesUtilityFrame)
        self.filesPathInput.setObjectName(u"filesPathInput")
        self.filesPathInput.setMinimumSize(QSize(220, 28))

        self.horizontalLayout_24.addWidget(self.filesPathInput)

        self.filesPathDropdownBtn = QToolButton(self.filesUtilityFrame)
        self.filesPathDropdownBtn.setObjectName(u"filesPathDropdownBtn")
        self.filesPathDropdownBtn.setMinimumSize(QSize(28, 28))
        self.filesPathDropdownBtn.setMaximumSize(QSize(28, 28))
        iconFilesPathDropdown = QIcon()
        iconFilesPathDropdown.addFile(u":/icons/icons/chevron-down.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.filesPathDropdownBtn.setIcon(iconFilesPathDropdown)
        self.filesPathDropdownBtn.setIconSize(QSize(16, 16))

        self.horizontalLayout_24.addWidget(self.filesPathDropdownBtn)
...
# endif // QT_CONFIG(shortcut)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.fileStackTitleBtn.setText(
            QCoreApplication.translate("MainWindow", u"Files", None))
        self.filesBackBtn.setText("")
        self.filesForwardBtn.setText("")
        self.filesUpBtn.setText("")
        self.filesHomeBtn.setText("")
        self.filesPathInput.setPlaceholderText(QCoreApplication.translate(
            "MainWindow", u"Open a folder path...", None))
        self.filesPathDropdownBtn.setText("")
        self.filesPathDropdownBtn.setToolTip(QCoreApplication.translate(
            "MainWindow", u"Open parent folders", None))
